...
export default function (pdfjsWrapper) {
  ...
  return {
    ...
    watch: {
      ...
      page: function () {
        this.pdf.loadPage(this.page, this.rotate, this.mult);
      },
      rotate: function () {
        this.pdf.renderPage(this.rotate, this.mult);
      },
      mult: function () {
        this.pdf.renderPage(this.rotate, this.mult);
      },
    ...
    methods: {
      resize: function (size) {
        ...
        if (resolutionScale < 0.85 || resolutionScale > 1.15) this.pdf.renderPage(this.rotate, this.multiply);
