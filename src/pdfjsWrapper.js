...
export default function (PDFJS) {
  ...
  function PDFJSWrapper(canvasElt, annotationLayerElt, emitEvent) {
    ...
    this.renderPage = function (rotate, multiply) {
      if (pdfRender !== null) {
        if (canceling) return;
        canceling = true;
        pdfRender.cancel();
      ...
      var viewport = pdfPage.getViewport({ scale: scale * multiply, rotation: pageRotate });
            ...
            .catch(
              function (err) {
                ...
                if (err instanceof PDFJS.RenderingCancelledException) {
                  canceling = false;
                  this.renderPage(rotate, multiply);
                  return;
                }
                emitEvent("error", err);
              }.bind(this)
    ...
    this.loadPage = function (pageNumber, rotate, multiply) {
      pdfPage = null;
